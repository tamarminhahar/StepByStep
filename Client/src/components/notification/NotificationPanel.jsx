...
import styles from './notificationStyle/NotificationPanel.module.css'; // משתמש בקובץ ה־CSS שכבר קיים
import { fetchNotifications, markNotificationAsRead, markAllNotificationsAsRead } from '../notification/notificationService'; // נוודא שהנתיב נכון
      ...
      {mode === 'popup' ? (
        <div className={styles.notificationHeader}>
          ...
          <div>
            ...
            <button className={styles.notificationCloseButton} onClick={() => setVisible(false)}>
              ✕
            </button>
          </div>
        </div>
